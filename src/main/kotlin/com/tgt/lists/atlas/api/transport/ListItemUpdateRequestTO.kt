...
data class ListItemUpdateRequestTO(
    ...
    fun validate(): ListItemUpdateRequestTO {
        ...
        if (itemType != null && itemType != ItemType.TCIN) {
            throw BadRequestException(ErrorCode(REQUEST_BODY_VIOLATION_ERROR_CODE.first, REQUEST_BODY_VIOLATION_ERROR_CODE.second, arrayListOf("Invalid Item type, Item can only be updated from GENERIC to TCIN type ")))
        }
