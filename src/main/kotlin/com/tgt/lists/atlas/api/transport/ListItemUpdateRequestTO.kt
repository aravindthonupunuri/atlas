...
data class ListItemUpdateRequestTO(
    ...
    fun validate(): ListItemUpdateRequestTO {
        ...
        if (refIdValidator.requireRefId(this) && isNullOrEmpty(itemRefId)) {
            throw BadRequestException(AppErrorCodes.ITEM_TYPE_REQUEST_BODY_VIOLATION_ERROR_CODE(arrayListOf("RefId is required")))
        }
